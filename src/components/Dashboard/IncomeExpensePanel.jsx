...
const IncomeExpensePanel = ({title, setIsActive}) => {
    ...
    return (
        <div className={`w-1/2 ${color} rounded-3xl py-8 px-10  shadow-blockShadow`}>
            {/* Название */}
            <h1 className="text-4xl font-bold mb-4 drop-shadow">{title}</h1>

            {/* Ячейка */}
            <div className="w-full bg-white bg-opacity-60 rounded-3xl flex items-center justify-between px-4 py-3 mb-8 shadow-blockShadow">
